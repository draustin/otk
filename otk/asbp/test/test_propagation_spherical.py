...
import otk.h4t
from otk import asbp, bvar, functions
...
def test_propagate_plane_to_plane_spherical():
    ...
    for rs_center, qs_center, r_offsets, q_offsets in zip(r_centerss, q_centerss, r_offsetss, q_offsetss):
        ...
        Er1 = asbp.propagate_plane_to_plane_spherical(k, r0_supports, Er0.copy(), z, m, rs_center, qs_center,
                                                      r1_centers,
                                                      kz_mode)
    ...
    for trial_num, trial in tuple(enumerate(trials)):
        ...
        for kz_mode in ('local_xy', 'paraxial'):
            Er1, propagator = asbp.invert_plane_to_curved_sst_arbitrary(k, r1_supports, num_pointss1, Er2, z2 - z1,
                                                                        x2, y2, roc12_x, roc12_y, r1_centers, qs_center,
                                                                        r2_centers, kz_mode, invert_kwargs)
            ...
            if trial == trials[-1]:
                ...
                Er1 = asbp.propagate_curved_to_plane_sst_arbitrary(k, x2, y2, Er2, roc21_x, roc21_y, z1 - z2,
                                                                   r1_supports,
                                                                   num_pointss1, r2_centers, qs_center, r1_centers,
                                                                   kz_mode, invert_kwargs)
