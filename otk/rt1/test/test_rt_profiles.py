...
from otk.rt1 import _profiles
from otk import v4hb


def test_SphericalProfile():
    profile = _profiles.SphericalProfile(10)
    ...
    assert np.isclose(profile.calc_z(5, 6), _profiles.Profile.calc_z(profile, 5, 6))


def test_SphericalSquareArrayProfile():
    profile = _profiles.SphericalSquareArrayProfile(10, 20)
...
def test_LatticeProfile():
    ...
    spherical_profile = _profiles.SphericalProfile(10)
    profile = _profiles.LatticeProfile(lattice, spherical_profile)
