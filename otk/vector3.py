"""General (non-optics-specific) 3D vector math using affine transformations.
...
__all__ = ['dot', 'normalize', 'norm', 'make_translation', 'make_rotation', 'make_y_rotation', 'make_x_rotation',
    'cross', 'transform', 'stack_xyzw']
